...
export default function Recipe(props) {
    const { handleRecipeDeleteButton, handleRecipeSelect } = useContext(RecipeContext)
    ...
    return (
        <div className="recipe">
            <div className="recipe__header">
                ...
                <div>
                    <button className="btn btn--primary mr-1" onClick={() => handleRecipeSelect(id)}>Edit ✏️</button>
