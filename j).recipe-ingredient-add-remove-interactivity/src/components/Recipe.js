...
export default function Recipe(props) {
    const { id, name, cookTime, servings, instructions, ingredients, handleRecipeDeleteButton } = props
    return (
        <div className="recipe">
            <div className="recipe__header">
                ...
                <div>
                    ...
                    <button className="btn btn--danger" onClick={() => handleRecipeDeleteButton(id)}>Delete</button>
                </div>
            </div>
